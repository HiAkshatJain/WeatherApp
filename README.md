...
This is a simple weather application built using HTML, CSS, and JavaScript, utilizing the OpenWeather API to fetch and display current weather information.

## Features

- Displays current weather conditions (temperature, description, humidity, wind speed).
